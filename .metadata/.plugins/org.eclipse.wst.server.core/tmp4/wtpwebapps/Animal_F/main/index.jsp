...
<body>
	...
	<script type="text/javascript">
		$(document).ready(function() {
			...
			$("#savemenu").click(function() {
				$("#container").load("../save/saveboard.jsp");
			});
	...
	<div id="header">
		<table border='1' bgcolor='#F0F0F0' align='center'
					...
					<table style="width: 100%">
						...
						<tr>
							...
							<td align="right" valign="top"><a href="./index.jsp">Home</a>
								<a href="#">로그인</a> <a id="join">회원가입</a></td>
						</tr>
					</table>
				</td>
			</tr>
			<tr bgcolor='#BDDD7D' height="10%">
				<td width='200' align='center'><a href='doc1.html'
					target='view'>찾습니다</a></td>
				<td width='200' align='center'><a id="savemenu">보호중입니다</a></td>
				<td width='200' align='center'><a href='#' target='view'>알바</a>
				</td>
	...
	<div id="footer">
		<table width="100%" border="1">
			...
			<col width="20%">
			<tr>
				<td colspan="4"><img src="../board/image/line.PNG" width="100%">
				</td>
			</tr>
			<tr>
				<td>1</td>
